...
const project = {
  id: "proj-001",
  name: "Projeto Dermatoglifia",
  description:
    "Projeto dos pacientes que estão passando por cirurgias do Hospital Estadual de Passo fundo",
};
...
export default function HomePage() {
  const { fetchMultiple, loading } = useMultipleApi();
